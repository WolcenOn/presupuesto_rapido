...
window.onload = () => {
    ...
    document.getElementById('v-ref').innerText = "REF: " + Math.floor(Math.random()*9000);
    applyCfg();
    refreshSel();
};
...
function saveCfg() {
    ...
    applyCfg(); alert("Empresa guardada");
}
...
function applyCfg() {
    document.getElementById('v-emp').innerText = cfg.n || "EMPRESA";
